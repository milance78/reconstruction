...
export type SnowOffIconProps = SVGProps<SVGSVGElement> & {
  title?: string;
};

const SnowOffIcon = forwardRef<SVGSVGElement, SnowOffIconProps>(
  ({ title, ...props }, ref) => (
    <svg
      width="256"
      height="256"
...
SnowOffIcon.displayName = "SnowOffIcon";

export { SnowOffIcon as ReactComponent };
export default SnowOffIcon;
